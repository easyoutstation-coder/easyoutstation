...
const ROUTES: Record<string, {
  ...
  "delhi-to-manali": {
    ...
    fare: { min: 9030, max: 15780 }, toll: 850,
  ...
  "delhi-to-shimla": {
    ...
    fare: { min: 5940, max: 10310 }, toll: 650,
  ...
  "delhi-to-chandigarh": {
    ...
    fare: { min: 4480, max: 7730 }, toll: 380,
  ...
  "delhi-to-jaipur": {
    ...
    fare: { min: 4800, max: 8300 }, toll: 350,
    ...
    faqs: [
      ...
      { q: "What is the cheapest cab from Delhi to Jaipur?", a: "Swift Dzire starts from ₹4,800 one way. Price includes driver charges. Toll is charged at actuals." },
    ]
  },
  "delhi-to-agra": {
    from: "Delhi", to: "Agra", distance: 230, duration: "3-4 hours",
    fare: { min: 3990, max: 6860 }, toll: 290,
  ...
  "delhi-to-rishikesh": {
    ...
    fare: { min: 4310, max: 7440 }, toll: 450,
  ...
  "delhi-to-dehradun": {
    ...
    fare: { min: 5130, max: 8880 }, toll: 420,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Dehradun cab?", a: "Fares start from ₹5,130 for a sedan to ₹8,880 for a premium SUV. Price includes driver charges. Toll is charged at actuals." },
    ]
  },
  "delhi-to-mussoorie": {
    from: "Delhi", to: "Mussoorie", distance: 310, duration: "6-7 hours",
    fare: { min: 5290, max: 9160 }, toll: 430,
  ...
  "delhi-to-nainital": {
    ...
    fare: { min: 5290, max: 9160 }, toll: 420,
    ...
    faqs: [
      ...
      { q: "What is the cab fare from Delhi to Nainital?", a: "Fares start from ₹5,290 for a sedan to ₹9,160 for a premium SUV. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-mathura": {
    ...
    fare: { min: 3090, max: 5280 }, toll: 250,
    ...
    faqs: [
      ...
      { q: "What is the cheapest Delhi to Mathura cab fare?", a: "A Swift Dzire starts from ₹3,090 one way. Price includes driver charges. Toll is charged at actuals." },
    ]
  },
  "delhi-to-amritsar": {
    from: "Delhi", to: "Amritsar", distance: 460, duration: "7-8 hours",
    fare: { min: 7730, max: 13480 }, toll: 600,
    ...
    faqs: [
      ...
      { q: "What is the cab fare from Delhi to Amritsar?", a: "Fares start from ₹7,730 for a Swift Dzire to ₹13,480 for an Innova Hycross one way. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-dharamshala": {
    ...
    fare: { min: 7970, max: 13910 }, toll: 700,
    ...
    faqs: [
      ...
      { q: "What is the cab fare from Delhi to Dharamshala?", a: "Fares start from ₹7,970 for a Swift Dzire to ₹13,910 for an Innova Hycross one way. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-kashmir": {
    ...
    fare: { min: 13580, max: 23830 }, toll: 1200,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Kashmir cab?", a: "Fares start from ₹13,580 for a sedan to ₹23,830 for an Innova Hycross. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-vaishno-devi": {
    ...
    fare: { min: 10810, max: 18940 }, toll: 900,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Vaishno Devi cab?", a: "Fares start from ₹10,810 for a sedan to ₹18,940 for an Innova Hycross. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-ludhiana": {
    ...
    fare: { min: 5290, max: 9160 }, toll: 450,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Ludhiana cab?", a: "Fares start from ₹5,290 for a Swift Dzire to ₹9,160 for an Innova Hycross. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-ayodhya": {
    ...
    fare: { min: 10650, max: 18650 }, toll: 850,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Ayodhya cab?", a: "Fares start from ₹10,650 for a sedan to ₹18,650 for an Innova Hycross. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-banaras": {
    ...
    fare: { min: 13580, max: 23830 }, toll: 1100,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Banaras cab?", a: "Fares start from ₹13,580 for a sedan to ₹23,830 for an Innova Hycross. Price includes driver charges. Toll is charged at actuals." },
  ...
  "delhi-to-haridwar": {
    ...
    fare: { min: 3830, max: 6580 }, toll: 320,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Haridwar cab?", a: "Fares start from ₹3,830 for a Swift Dzire to ₹6,580 for an Innova Hycross. Price includes driver charges. Toll & parking charged at actuals." },
  ...
  "delhi-to-jodhpur": {
    ...
    fare: { min: 10000, max: 17500 }, toll: 850,
    ...
    faqs: [
      ...
      { q: "What is the cab fare from Delhi to Jodhpur?", a: "Fares start from ₹10,000 for a sedan to ₹17,500 for an Innova Hycross. Price includes driver charges. Toll & state tax charged at actuals." },
  ...
  "delhi-to-udaipur": {
    ...
    fare: { min: 11060, max: 19370 }, toll: 950,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Udaipur cab?", a: "Fares start from ₹11,060 for a sedan to ₹19,370 for an Innova Hycross. Price includes driver charges. Toll & state tax charged at actuals." },
  ...
  "delhi-to-pushkar": {
    ...
    fare: { min: 6670, max: 11610 }, toll: 550,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Pushkar cab?", a: "Fares start from ₹6,670 for a sedan to ₹11,610 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "delhi-to-corbett": {
    ...
    fare: { min: 4310, max: 7440 }, toll: 380,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Jim Corbett cab?", a: "Fares start from ₹4,310 for a sedan to ₹7,440 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "delhi-to-kasauli": {
    ...
    fare: { min: 5370, max: 9310 }, toll: 480,
  ...
  "delhi-to-dalhousie": {
    ...
    fare: { min: 9270, max: 16210 }, toll: 800,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Dalhousie cab?", a: "Fares start from ₹9,270 for a sedan to ₹16,210 for an Innova Hycross. Price includes driver charges. Toll & Himachal state tax charged at actuals." },
  ...
  "delhi-to-lucknow": {
    ...
    fare: { min: 9270, max: 16210 }, toll: 750,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Lucknow cab?", a: "Fares start from ₹9,270 for a sedan to ₹16,210 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "delhi-to-prayagraj": {
    ...
    fare: { min: 10730, max: 18790 }, toll: 900,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Prayagraj cab?", a: "Fares start from ₹10,730 for a sedan to ₹18,790 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "delhi-to-vrindavan": {
    ...
    fare: { min: 2770, max: 4710 }, toll: 220,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Vrindavan cab?", a: "Fares start from ₹2,770 for a sedan to ₹4,710 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "delhi-to-spiti": {
    ...
    fare: { min: 13010, max: 22820 }, toll: 950,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Spiti cab?", a: "Fares start from ₹13,010 for a sedan to ₹22,820 for a premium SUV. Spiti roads require an SUV — we strongly recommend Innova Crysta or higher. Toll & HP state tax charged at actuals." },
  ...
  "delhi-to-mount-abu": {
    ...
    fare: { min: 12930, max: 22680 }, toll: 1100,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Mount Abu cab?", a: "Fares start from ₹12,930 for a sedan to ₹22,680 for an Innova Hycross. Price includes driver charges. Toll & state tax charged at actuals." },
  ...
  "delhi-to-lansdowne": {
    ...
    fare: { min: 4560, max: 7870 }, toll: 380,
    ...
    faqs: [
      ...
      { q: "What is the fare for Delhi to Lansdowne cab?", a: "Fares start from ₹4,560 for a sedan to ₹7,870 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "delhi-to-kedarnath": {
    ...
    fare: { min: 7890, max: 13760 }, toll: 680,
    ...
    faqs: [
      ...
      { q: "What is the cab fare from Delhi to Kedarnath (Gaurikund)?", a: "Fares start from ₹7,890 for a sedan to ₹13,760 for an Innova Hycross. Price includes driver charges. Toll & Uttarakhand state tax charged at actuals." },
  ...
  "chandigarh-to-manali": {
    ...
    fare: { min: 5370, max: 9310 }, toll: 400,
    ...
    faqs: [
      ...
      { q: "What is the fare for Chandigarh to Manali cab?", a: "Fares start from ₹5,370 for a sedan to ₹9,310 for an Innova Hycross. Price includes driver charges. Toll & HP state tax charged at actuals." },
  ...
  "chandigarh-to-shimla": {
    ...
    fare: { min: 2120, max: 3560 }, toll: 200,
    ...
    faqs: [
      ...
      { q: "What is the fare for Chandigarh to Shimla cab?", a: "Fares start from ₹2,120 for a sedan to ₹3,560 for an Innova Hycross. Price includes driver charges. Toll & HP state tax charged at actuals." },
  ...
  "chandigarh-to-dharamshala": {
    ...
    fare: { min: 4230, max: 7290 }, toll: 380,
    ...
    faqs: [
      ...
      { q: "What is the fare for Chandigarh to Dharamshala cab?", a: "Fares start from ₹4,230 for a sedan to ₹7,290 for an Innova Hycross. Price includes driver charges. Toll & HP state tax charged at actuals." },
  ...
  "chandigarh-to-amritsar": {
    ...
    fare: { min: 3990, max: 6860 }, toll: 350,
    ...
    faqs: [
      ...
      { q: "What is the fare for Chandigarh to Amritsar cab?", a: "Fares start from ₹3,990 for a sedan to ₹6,860 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
  ...
  "shimla-to-manali": {
    ...
    fare: { min: 3830, max: 6580 }, toll: 300,
    ...
    faqs: [
      ...
      { q: "What is the fare for Shimla to Manali cab?", a: "Fares start from ₹3,830 for a sedan to ₹6,580 for an Innova Hycross. Price includes driver charges. HP state tax charged at actuals." },
  ...
  "shimla-to-dharamshala": {
    ...
    fare: { min: 4720, max: 8160 }, toll: 350,
    ...
    faqs: [
      ...
      { q: "What is the fare for Shimla to Dharamshala cab?", a: "Fares start from ₹4,720 for a sedan to ₹8,160 for an Innova Hycross. Price includes driver charges. HP state tax charged at actuals." },
  ...
  "manali-to-leh": {
    ...
    fare: { min: 8050, max: 14050 }, toll: 450,
    ...
    faqs: [
      ...
      { q: "What is the fare for Manali to Leh cab?", a: "Fares start from ₹8,050 for an SUV (sedans are not suitable). We strongly recommend Innova Crysta or Hycross. Price includes driver charges. Toll & Army check-post fees charged at actuals." },
  ...
  "manali-to-spiti": {
    ...
    fare: { min: 3830, max: 6580 }, toll: 250,
    ...
    faqs: [
      ...
      { q: "What is the fare for Manali to Spiti cab?", a: "Fares start from ₹3,830 for a suitable SUV (sedans not recommended). Price includes driver charges. Rohtang permit fee (₹550) and HP state tax charged at actuals." },
  ...
  "manali-to-kasol": {
    ...
    fare: { min: 1550, max: 2550 }, toll: 100,
    ...
    faqs: [
      ...
      { q: "What is the fare for Manali to Kasol cab?", a: "Fares start from ₹1,550 for a sedan to ₹2,550 for an Innova Hycross. Price includes driver charges. HP state tax charged at actuals." },
  ...
  "amritsar-to-dharamshala": {
    ...
    fare: { min: 3500, max: 6000 }, toll: 300,
    ...
    faqs: [
      ...
      { q: "What is the fare for Amritsar to Dharamshala cab?", a: "Fares start from ₹3,500 for a sedan to ₹6,000 for an Innova Hycross. Price includes driver charges. Toll & HP state tax charged at actuals." },
  ...
  "ludhiana-to-amritsar": {
    ...
    fare: { min: 2360, max: 3990 }, toll: 200,
    ...
    faqs: [
      ...
      { q: "What is the fare for Ludhiana to Amritsar cab?", a: "Fares start from ₹2,360 for a sedan to ₹3,990 for an Innova Hycross. Price includes driver charges. Toll charged at actuals." },
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20">
        ...
        <div className="relative overflow-hidden bg-slate-900">
          ...
          {/* Dark overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-slate-900/65 via-slate-900/70 to-slate-900/85" />
          ...
          <div className="absolute inset-0 flex items-center justify-center px-4 py-10">
            <div className="text-white text-center max-w-4xl w-full">
              ...
              <h1 className="text-4xl md:text-5xl font-bold font-['DM_Serif_Display'] mb-4" style={{ textShadow: "0 2px 14px rgba(0,0,0,0.9), 0 1px 4px rgba(0,0,0,0.8)" }}>
