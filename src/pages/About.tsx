  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="pt-20">
        {/* Hero */}
        <div className="bg-[#0B2447] py-12 sm:py-20 px-4">
          <div className="relative max-w-4xl mx-auto text-center">
              <p className="text-xs font-bold uppercase tracking-widest text-blue-300 mb-3">Our Story</p>
        ...
        <div className="bg-white border-b border-slate-100">
            <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={i}>
                  <div className="text-2xl sm:text-3xl font-bold text-primary">{s.num}</div>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="p-4 rounded-xl bg-slate-50 border border-slate-100 cursor-default">
