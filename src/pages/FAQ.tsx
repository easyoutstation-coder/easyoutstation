...
const FALLBACK_FAQS = [
  ...
  // --- Multi-Stop Tour FAQs ---
  { question: "What is a Multi-Stop Tour?", answer: "A Multi-Stop Tour lets you visit several destinations in one booking — for example, Delhi → Nainital → Mussoorie → Rishikesh → Haridwar → Delhi. It is always a round-trip circuit that starts and ends in Delhi. The driver covers all your stops and returns to Delhi at the end. You can add up to 8 destinations from our approved list covering 35+ cities across North India." },
  { question: "How is the Multi-Stop Tour fare calculated?", answer: "The fare is calculated on the full circuit distance (Delhi → all stops → Delhi) plus a minimum billing of 250 km per day. Formula: max(actual circuit km, days × 250) × price per km + ₹250 driver charge per day. There is no one-way surcharge on tours. The fare shown at booking is indicative — if any route or distance changes are needed, our team will communicate revised pricing before the trip starts. Toll and parking are charged at actuals." },
  { question: "What if I don't physically return to Delhi at the end of my tour?", answer: "No problem. If you end your trip at a different city, the fare still includes the Delhi-return leg because the driver needs to bring the vehicle back to Delhi. The quoted fare already accounts for the full circuit, so your price doesn't change based on where your personal journey ends." },
  { question: "Which destinations can I add to a Multi-Stop Tour?", answer: "You can add stops from our full approved destination list: Nainital, Mussoorie, Rishikesh, Haridwar, Dehradun, Corbett, Lansdowne, Kedarnath, Badrinath, Shimla, Manali, Chandigarh, Dharamshala, Kasauli, Dalhousie, Kasol, Spiti, Leh, Amritsar, Ludhiana, Jaipur, Agra, Mathura, Vrindavan, Jodhpur, Udaipur, Pushkar, Mount Abu, Lucknow, Ayodhya, Varanasi, Prayagraj, Kashmir (Srinagar), and Vaishno Devi. The Tour tab on the booking widget lets you search and add stops." },
