...
const FALLBACK_FAQS = [
  ...
  { question: "Does EasyOutstation have a referral program?", answer: "Yes! Refer a friend and you both earn ₹100 travel credit when they complete their first ride. Credits are added within 24 hours of trip completion and are valid for 90 days. There's no limit on referrals — refer as many people as you like and credits accumulate in your dashboard." },
