...
const FALLBACK_FAQS = [
  ...
  { question: "Which cities do you serve?", answer: "We serve outstation routes from Delhi NCR to 9 cities: Manali, Shimla, Jaipur, Agra, Rishikesh, Haridwar, Dehradun, and Chandigarh. Pickup is from Delhi NCR (New Delhi, Gurgaon, Noida, Faridabad, Ghaziabad). Destinations within 100km of any of these cities are also covered." },
  ...
  { question: "What types of cars are available?", answer: "Our fleet includes: Swift Dzire (economy sedan), Maruti Ertiga (MUV), Toyota Innova (MUV), Toyota Innova Crysta (premium), Toyota Innova Hycross (luxury hybrid), Force Urbania and Tempo Traveller (for larger groups), and BYD electric vehicles. All cars are AC, well-maintained, and driven by verified drivers." },
