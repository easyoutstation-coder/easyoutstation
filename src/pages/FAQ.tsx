...
const FALLBACK_FAQS = [
  ...
  { question: "Which cities do you serve?", answer: "We serve outstation routes from Delhi NCR to 18 destinations: Manali, Shimla, Dharamshala (McLeod Ganj), Kashmir (Srinagar), Vaishno Devi (Katra), Chandigarh, Ludhiana, Amritsar, Jaipur, Agra, Mathura, Rishikesh, Haridwar, Dehradun, Mussoorie, Nainital, Ayodhya, and Banaras (Varanasi). Pickup is available within 40 km of Delhi — covering New Delhi, Gurgaon, Noida, Faridabad, Ghaziabad, Rohtak, and Sonipat." },
