...
export default function CarsPage() {
  ...
  const fallbackCars = [
    ...
    { id: 18, name: "Tata Hexa", brand: "Tata", category: "muv", seats: 7, pricePerKm: "19.00", rating: "4.65", reviewCount: 28, imageUrl: "/cars/tata-hexa.jpg", isAvailable: true, description: "Powerful 6+1 seater MUV with bold design, VARICOR diesel engine, and captain seats. Ideal for family outstation trips.", fuelType: "diesel", transmission: "manual" },
