...
const footerLinks = {
  routes: [
    ...
    { label: "Delhi to Jodhpur", href: "/cab/delhi-to-jodhpur" },
    { label: "Delhi to Udaipur", href: "/cab/delhi-to-udaipur" },
    ...
    { label: "Delhi to Corbett", href: "/cab/delhi-to-corbett" },
    { label: "Delhi to Dharamshala", href: "/cab/delhi-to-dharamshala" },
    { label: "Delhi to Amritsar", href: "/cab/delhi-to-amritsar" },
    { label: "Delhi to Lucknow", href: "/cab/delhi-to-lucknow" },
    { label: "Delhi to Ayodhya", href: "/cab/delhi-to-ayodhya" },
    { label: "Delhi to Banaras", href: "/cab/delhi-to-banaras" },
  ...
  guides: [
    ...
    { label: "Delhi to Udaipur Guide", href: "/blog/delhi-to-udaipur-road-trip-guide" },
    { label: "Delhi to Jodhpur Guide", href: "/blog/delhi-to-jodhpur-road-trip-guide" },
    { label: "Delhi to Corbett Guide", href: "/blog/delhi-to-jim-corbett-safari-guide" },
    { label: "Delhi to Lucknow Guide", href: "/blog/delhi-to-lucknow-travel-guide" },
    { label: "Delhi to Prayagraj Guide", href: "/blog/delhi-to-prayagraj-sangam-guide" },
    { label: "Delhi to Pushkar Guide", href: "/blog/delhi-to-pushkar-travel-guide" },
    { label: "Delhi to Dalhousie Guide", href: "/blog/delhi-to-dalhousie-travel-guide" },
    { label: "Delhi to Spiti Valley Guide", href: "/blog/delhi-to-spiti-valley-guide" },
    { label: "Delhi to Mount Abu Guide", href: "/blog/delhi-to-mount-abu-travel-guide" },
    { label: "Delhi to Kasauli Guide", href: "/blog/delhi-to-kasauli-travel-guide" },
    { label: "Delhi to Lansdowne Guide", href: "/blog/delhi-to-lansdowne-travel-guide" },
    { label: "Delhi to Vrindavan Guide", href: "/blog/delhi-to-vrindavan-day-trip-guide" },
