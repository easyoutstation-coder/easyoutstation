...
const features = [
  ...
  { icon: Wallet, title: "Zero Hidden Charges", description: PRICING_INCLUSION_LINE, tag: "Transparent" },
...
export default function FeaturesSection() {
  return (
    <section id="features" className="scroll-mt-20 py-12 sm:py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <p className="text-xs font-semibold text-blue-600 uppercase tracking-wider mb-3">Why Travelers Choose Us</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {features.map((f, i) => (
              <div key={i} className="group p-6 rounded-2xl border border-slate-100 hover:border-blue-100 bg-white hover:bg-blue-50/30 transition-colors duration-300 cursor-default">
