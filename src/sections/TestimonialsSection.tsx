      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Header */}
          <div className="text-center max-w-2xl mx-auto mb-14">
            <p className="text-xs font-semibold text-blue-600 uppercase tracking-wider mb-3">Our Commitment</p>
        ...
        {/* Promise cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-14">
            {promises.map((p, i) => (
              <div key={i} className={`rounded-2xl border p-6 ${p.color} cursor-default`}>
