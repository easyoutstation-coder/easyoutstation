...
export default function CorporateSection() {
  return (
    <section id="corporate" className="relative overflow-hidden bg-[#0B2447] scroll-mt-20 py-12 sm:py-20">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            {/* Left — pitch */}
            <div>
              <div className="inline-flex items-center gap-2 text-blue-300 text-[11px] font-bold uppercase tracking-[0.15em] border border-blue-500/25 bg-blue-500/10 px-4 py-2 rounded-full mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {perks.map((p) => (
                  <div key={p.title} className="flex gap-3 p-4 rounded-xl bg-white/5 border border-white/10 cursor-default">
              ...
              <Link
                to="/corporate"
                className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-8 h-12 rounded-xl shadow-lg transition-all"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="rounded-2xl bg-white/5 border border-white/10 p-5 text-center cursor-default">
