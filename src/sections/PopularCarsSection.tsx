...
import { RATE } from "@/data/carRates";
const fallbackCars = [
  { id: 6,  name: "Toyota Innova Crysta",  brand: "Toyota", category: "premium", seats: 6, pricePerKm: RATE.crysta.pricePerKm,  rating: "4.90", imageUrl: "/cars/toyota-innova-crysta.jpg",  description: "India's most trusted outstation cab. Powerful, spacious, built for long journeys.", fuelType: "Diesel" },
  { id: 8,  name: "Toyota Innova Hycross", brand: "Toyota", category: "luxury",  seats: 6, pricePerKm: RATE.hycross.pricePerKm, rating: "4.95", imageUrl: "/cars/toyota-innova-hycross.jpg", description: "Flagship hybrid luxury — the smoothest ride for premium corporate travel.", fuelType: "Hybrid" },
  { id: 5,  name: "Toyota Innova",         brand: "Toyota", category: "muv",     seats: 6, pricePerKm: RATE.innova.pricePerKm,  rating: "4.80", imageUrl: "/cars/toyota-innova.jpg",          description: "Reliable family workhorse. Comfortable on highways and mountain roads alike.", fuelType: "Diesel" },
  { id: 1,  name: "Swift Dzire",           brand: "Maruti", category: "sedan",   seats: 5, pricePerKm: RATE.sedan.pricePerKm,   rating: "4.70", imageUrl: "/cars/swift-dzire.jpg",            description: "Best value for solo travelers and couples. Fuel-efficient and highway comfortable.", fuelType: "Petrol/CNG" },
];
            ...
            {displayCars.map((car) => {
              ...
              return (
                <div key={car.id} onClick={() => navigate(`/cars/${car.id}`)}
                  className="group bg-white rounded-2xl border border-slate-100 hover:border-blue-200 overflow-hidden cursor-pointer">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                      <div>
                        <span className="text-base font-bold text-primary">₹{car.pricePerKm}</span>
